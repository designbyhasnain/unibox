...
function AcceptInviteContent() {
    ...
    const handleAccept = () => {
        setIsAccepting(true);
        // Redirect to Google OAuth with invite token in state
            ...
            <div className="login-page">
                <div className="login-card">
                    <div className="login-header">
                        ...
                        <p style={{ color: 'var(--text-secondary)', marginTop: 16 }}>Validating invitation...</p>
                    </div>
                </div>
            </div>
        );
    ...
    return (
        <div className="login-page">
            <div className="login-card">
                ...
                <div className="login-body">
                    <div style={{
                        background: 'var(--bg-elevated, #f1f3f4)',
                        borderRadius: 12,
                        padding: '20px 24px',
                        marginBottom: 24,
                    }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 12 }}>
                            <span style={{ color: 'var(--text-secondary)', fontSize: 13 }}>Invited by</span>
                            <span style={{ color: 'var(--text-primary)', fontSize: 13, fontWeight: 500 }}>{invitation.inviterName}</span>
                        </div>
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 12 }}>
                            <span style={{ color: 'var(--text-secondary)', fontSize: 13 }}>Your name</span>
                            <span style={{ color: 'var(--text-primary)', fontSize: 13, fontWeight: 500 }}>{invitation.name}</span>
                        </div>
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 12 }}>
                            <span style={{ color: 'var(--text-secondary)', fontSize: 13 }}>Email</span>
                            <span style={{ color: 'var(--text-primary)', fontSize: 13, fontWeight: 500 }}>{invitation.email}</span>
                        </div>
