'use client';
import { SkeletonTableRow } from '../components/LoadingStates';

export default function Loading() {
    return (
        <div style={{ padding: '2rem', maxWidth: 960, margin: '0 auto' }}>
            <div className="skeleton-row-stagger" style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 24 }}>
