'use client';
import { SkeletonTableRow, LoadingText } from '../components/LoadingStates';

export default function Loading() {
    return (
        <div style={{ padding: '2rem', maxWidth: 960, margin: '0 auto' }}>
            <LoadingText context="team" />
            <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '1rem', marginBottom: 24 }}>
